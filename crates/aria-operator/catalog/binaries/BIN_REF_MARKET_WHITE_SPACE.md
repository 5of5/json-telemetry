# BIN.REF.MARKET_WHITE_SPACE

**Operator:** `REF.MARKET_WHITE_SPACE` · **layer:** REFINEMENT · **class:** REFINEMENT · **parent:** MARKET_MAP
**Crate:** `aria-ref-market-white-space` · **verify:** True · **result:** `map.ref.market_white_space`
...
`work --binary BIN.REF.MARKET_WHITE_SPACE` or `work --json` with `ops: ["BIN.REF.MARKET_WHITE_SPACE"]`
...
- anchor tags: COMPANY, MARKET, CATEGORY, Market White Space, MAP_TYPE
- property key: —
