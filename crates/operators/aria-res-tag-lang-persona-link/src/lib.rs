//! Unique operator "BIN.TAG.LANG_PERSONA_LINK" ("TAG.LANG_PERSONA_LINK").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_PERSONA_LINK";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_PERSONA_LINK";
