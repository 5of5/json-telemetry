//! Unique operator "BIN.TAG.PERSON_COMMERCIAL_STRATEGY" ("TAG.PERSON_COMMERCIAL_STRATEGY").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_COMMERCIAL_STRATEGY";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_COMMERCIAL_STRATEGY";
