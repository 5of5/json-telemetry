//! Unique operator "BIN.TAG.CAT_MARKET_EXPANSION" ("TAG.CAT_MARKET_EXPANSION").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CAT_MARKET_EXPANSION";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CAT_MARKET_EXPANSION";
