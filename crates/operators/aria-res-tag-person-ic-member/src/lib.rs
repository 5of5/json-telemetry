//! Unique operator "BIN.TAG.PERSON_IC_MEMBER" ("TAG.PERSON_IC_MEMBER").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_IC_MEMBER";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_IC_MEMBER";
