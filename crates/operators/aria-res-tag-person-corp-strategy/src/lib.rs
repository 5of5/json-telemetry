//! Unique operator "BIN.TAG.PERSON_CORP_STRATEGY" ("TAG.PERSON_CORP_STRATEGY").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_CORP_STRATEGY";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_CORP_STRATEGY";
