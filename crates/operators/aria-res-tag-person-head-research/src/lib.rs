//! Unique operator "BIN.TAG.PERSON_HEAD_RESEARCH" ("TAG.PERSON_HEAD_RESEARCH").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_HEAD_RESEARCH";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_HEAD_RESEARCH";
