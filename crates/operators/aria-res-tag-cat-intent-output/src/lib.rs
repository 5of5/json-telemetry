//! Unique operator "BIN.TAG.CAT_INTENT_OUTPUT" ("TAG.CAT_INTENT_OUTPUT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CAT_INTENT_OUTPUT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CAT_INTENT_OUTPUT";
