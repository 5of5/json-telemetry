//! Unique operator "BIN.TAG.LANG_POSITIONING_LANE" ("TAG.LANG_POSITIONING_LANE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_POSITIONING_LANE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_POSITIONING_LANE";
