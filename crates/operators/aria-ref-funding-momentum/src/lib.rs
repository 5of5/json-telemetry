//! Unique operator "BIN.REF.FUNDING_MOMENTUM" ("REF.FUNDING_MOMENTUM").
//!
//! Map mixer: slices already-tagged JSON telemetry into this sealed
//! market-map type. Source bytes are never rewritten.

/// Catalog identity.
pub const BINARY_ID: &str = "BIN.REF.FUNDING_MOMENTUM";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "REF.FUNDING_MOMENTUM";
