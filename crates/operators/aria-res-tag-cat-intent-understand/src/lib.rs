//! Unique operator "BIN.TAG.CAT_INTENT_UNDERSTAND" ("TAG.CAT_INTENT_UNDERSTAND").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CAT_INTENT_UNDERSTAND";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CAT_INTENT_UNDERSTAND";
