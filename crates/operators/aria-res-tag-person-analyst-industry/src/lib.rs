//! Unique operator "BIN.TAG.PERSON_ANALYST_INDUSTRY" ("TAG.PERSON_ANALYST_INDUSTRY").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_ANALYST_INDUSTRY";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_ANALYST_INDUSTRY";
