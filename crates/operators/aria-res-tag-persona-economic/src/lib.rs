//! Unique operator "BIN.TAG.PERSONA_ECONOMIC" ("TAG.PERSONA_ECONOMIC").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSONA_ECONOMIC";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSONA_ECONOMIC";
