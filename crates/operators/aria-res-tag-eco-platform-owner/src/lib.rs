//! Unique operator "BIN.TAG.ECO_PLATFORM_OWNER" ("TAG.ECO_PLATFORM_OWNER").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.ECO_PLATFORM_OWNER";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.ECO_PLATFORM_OWNER";
