//! Unique operator "BIN.TAG.PERSONA_EXECUTIVE" ("TAG.PERSONA_EXECUTIVE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSONA_EXECUTIVE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSONA_EXECUTIVE";
