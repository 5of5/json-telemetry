//! Unique operator "BIN.PROP.CLUSTER_GRAVITY" ("PROP.CLUSTER_GRAVITY").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.PROP.CLUSTER_GRAVITY";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "PROP.CLUSTER_GRAVITY";
