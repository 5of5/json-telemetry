//! Unique operator "BIN.TAG.IND_KNOWLEDGE_GRAPHS" ("TAG.IND_KNOWLEDGE_GRAPHS").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.IND_KNOWLEDGE_GRAPHS";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.IND_KNOWLEDGE_GRAPHS";
