//! Unique operator "BIN.TAG.LANG_BUILDER_NODE" ("TAG.LANG_BUILDER_NODE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_BUILDER_NODE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_BUILDER_NODE";
