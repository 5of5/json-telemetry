//! Unique operator "BIN.TAG.LANG_MARKET_RISK" ("TAG.LANG_MARKET_RISK").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_MARKET_RISK";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_MARKET_RISK";
