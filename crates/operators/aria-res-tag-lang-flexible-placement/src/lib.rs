//! Unique operator "BIN.TAG.LANG_FLEXIBLE_PLACEMENT" ("TAG.LANG_FLEXIBLE_PLACEMENT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_FLEXIBLE_PLACEMENT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_FLEXIBLE_PLACEMENT";
