//! Unique operator "BIN.TAG.LANG_STACK_INFRA" ("TAG.LANG_STACK_INFRA").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_STACK_INFRA";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_STACK_INFRA";
