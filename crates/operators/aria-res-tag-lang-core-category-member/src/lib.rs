//! Unique operator "BIN.TAG.LANG_CORE_CATEGORY_MEMBER" ("TAG.LANG_CORE_CATEGORY_MEMBER").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_CORE_CATEGORY_MEMBER";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_CORE_CATEGORY_MEMBER";
