//! Unique operator "BIN.TAG.LANG_STACK_DISTRIBUTION" ("TAG.LANG_STACK_DISTRIBUTION").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_STACK_DISTRIBUTION";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_STACK_DISTRIBUTION";
