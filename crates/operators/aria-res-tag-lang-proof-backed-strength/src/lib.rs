//! Unique operator "BIN.TAG.LANG_PROOF_BACKED_STRENGTH" ("TAG.LANG_PROOF_BACKED_STRENGTH").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_PROOF_BACKED_STRENGTH";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_PROOF_BACKED_STRENGTH";
