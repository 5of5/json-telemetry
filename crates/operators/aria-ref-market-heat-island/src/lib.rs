//! Unique operator "BIN.REF.MARKET_HEAT_ISLAND" ("REF.MARKET_HEAT_ISLAND").
//!
//! Map mixer: slices already-tagged JSON telemetry into this sealed
//! market-map type. Source bytes are never rewritten.

/// Catalog identity.
pub const BINARY_ID: &str = "BIN.REF.MARKET_HEAT_ISLAND";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "REF.MARKET_HEAT_ISLAND";
