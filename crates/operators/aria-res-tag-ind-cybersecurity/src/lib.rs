//! Unique operator "BIN.TAG.IND_CYBERSECURITY" ("TAG.IND_CYBERSECURITY").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.IND_CYBERSECURITY";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.IND_CYBERSECURITY";
