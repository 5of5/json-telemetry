//! Unique operator "BIN.TAG.PERSONA_TECHNICAL" ("TAG.PERSONA_TECHNICAL").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSONA_TECHNICAL";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSONA_TECHNICAL";
