//! Unique operator "BIN.TAG.LANG_CLUSTER_GRAVITY" ("TAG.LANG_CLUSTER_GRAVITY").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_CLUSTER_GRAVITY";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_CLUSTER_GRAVITY";
