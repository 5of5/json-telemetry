//! Unique operator "BIN.TAG.LANG_CO_INVESTOR" ("TAG.LANG_CO_INVESTOR").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_CO_INVESTOR";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_CO_INVESTOR";
