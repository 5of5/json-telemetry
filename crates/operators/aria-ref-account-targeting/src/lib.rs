//! Unique operator "BIN.REF.ACCOUNT_TARGETING" ("REF.ACCOUNT_TARGETING").
//!
//! Map mixer: slices already-tagged JSON telemetry into this sealed
//! market-map type. Source bytes are never rewritten.

/// Catalog identity.
pub const BINARY_ID: &str = "BIN.REF.ACCOUNT_TARGETING";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "REF.ACCOUNT_TARGETING";
