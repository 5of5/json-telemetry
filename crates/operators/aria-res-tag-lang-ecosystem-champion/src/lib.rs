//! Unique operator "BIN.TAG.LANG_ECOSYSTEM_CHAMPION" ("TAG.LANG_ECOSYSTEM_CHAMPION").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_ECOSYSTEM_CHAMPION";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_ECOSYSTEM_CHAMPION";
