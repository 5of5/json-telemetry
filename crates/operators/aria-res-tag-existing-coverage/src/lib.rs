//! Unique operator "BIN.TAG.EXISTING_COVERAGE" ("TAG.EXISTING_COVERAGE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.EXISTING_COVERAGE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.EXISTING_COVERAGE";
