//! Unique operator "BIN.TAG.CO_POINT_SOLUTION" ("TAG.CO_POINT_SOLUTION").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CO_POINT_SOLUTION";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CO_POINT_SOLUTION";
