//! Unique operator "BIN.TAG.LANG_INFLUENCE_PATH" ("TAG.LANG_INFLUENCE_PATH").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_INFLUENCE_PATH";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_INFLUENCE_PATH";
