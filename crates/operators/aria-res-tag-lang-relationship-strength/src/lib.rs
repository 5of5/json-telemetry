//! Unique operator "BIN.TAG.LANG_RELATIONSHIP_STRENGTH" ("TAG.LANG_RELATIONSHIP_STRENGTH").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_RELATIONSHIP_STRENGTH";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_RELATIONSHIP_STRENGTH";
