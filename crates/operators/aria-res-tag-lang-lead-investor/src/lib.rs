//! Unique operator "BIN.TAG.LANG_LEAD_INVESTOR" ("TAG.LANG_LEAD_INVESTOR").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_LEAD_INVESTOR";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_LEAD_INVESTOR";
