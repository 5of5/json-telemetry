//! Unique operator "BIN.TAG.LANG_CAPABILITY_ATOM" ("TAG.LANG_CAPABILITY_ATOM").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_CAPABILITY_ATOM";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_CAPABILITY_ATOM";
