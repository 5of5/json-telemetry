//! Unique operator "BIN.TAG.LANG_LAUNCH_HEAT" ("TAG.LANG_LAUNCH_HEAT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_LAUNCH_HEAT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_LAUNCH_HEAT";
