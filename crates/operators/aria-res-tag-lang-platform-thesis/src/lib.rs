//! Unique operator "BIN.TAG.LANG_PLATFORM_THESIS" ("TAG.LANG_PLATFORM_THESIS").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_PLATFORM_THESIS";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_PLATFORM_THESIS";
