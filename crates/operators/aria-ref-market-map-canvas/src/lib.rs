//! Unique operator "BIN.REF.MARKET_MAP_CANVAS" ("REF.MARKET_MAP_CANVAS").
//!
//! Map mixer: slices already-tagged JSON telemetry into this sealed
//! market-map type. Source bytes are never rewritten.

/// Catalog identity.
pub const BINARY_ID: &str = "BIN.REF.MARKET_MAP_CANVAS";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "REF.MARKET_MAP_CANVAS";
