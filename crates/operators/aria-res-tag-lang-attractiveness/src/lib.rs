//! Unique operator "BIN.TAG.LANG_ATTRACTIVENESS" ("TAG.LANG_ATTRACTIVENESS").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_ATTRACTIVENESS";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_ATTRACTIVENESS";
