//! Unique operator "BIN.TAG.CO_OPEN_SOURCE_ORG" ("TAG.CO_OPEN_SOURCE_ORG").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CO_OPEN_SOURCE_ORG";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CO_OPEN_SOURCE_ORG";
