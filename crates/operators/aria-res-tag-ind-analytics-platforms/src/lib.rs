//! Unique operator "BIN.TAG.IND_ANALYTICS_PLATFORMS" ("TAG.IND_ANALYTICS_PLATFORMS").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.IND_ANALYTICS_PLATFORMS";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.IND_ANALYTICS_PLATFORMS";
