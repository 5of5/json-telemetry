//! Unique operator "BIN.TAG.PERSON_JOURNALIST" ("TAG.PERSON_JOURNALIST").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_JOURNALIST";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_JOURNALIST";
