//! Unique operator "BIN.REF.NARRATIVE_POSITIONING" ("REF.NARRATIVE_POSITIONING").
//!
//! Map mixer: slices already-tagged JSON telemetry into this sealed
//! market-map type. Source bytes are never rewritten.

/// Catalog identity.
pub const BINARY_ID: &str = "BIN.REF.NARRATIVE_POSITIONING";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "REF.NARRATIVE_POSITIONING";
