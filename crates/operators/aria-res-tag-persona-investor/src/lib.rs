//! Unique operator "BIN.TAG.PERSONA_INVESTOR" ("TAG.PERSONA_INVESTOR").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSONA_INVESTOR";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSONA_INVESTOR";
