//! Unique operator "BIN.REF.PARTNERSHIP_PATH" ("REF.PARTNERSHIP_PATH").
//!
//! Map mixer: slices already-tagged JSON telemetry into this sealed
//! market-map type. Source bytes are never rewritten.

/// Catalog identity.
pub const BINARY_ID: &str = "BIN.REF.PARTNERSHIP_PATH";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "REF.PARTNERSHIP_PATH";
