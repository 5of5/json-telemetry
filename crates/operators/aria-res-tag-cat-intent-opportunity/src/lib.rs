//! Unique operator "BIN.TAG.CAT_INTENT_OPPORTUNITY" ("TAG.CAT_INTENT_OPPORTUNITY").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CAT_INTENT_OPPORTUNITY";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CAT_INTENT_OPPORTUNITY";
