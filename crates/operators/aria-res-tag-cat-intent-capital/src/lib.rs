//! Unique operator "BIN.TAG.CAT_INTENT_CAPITAL" ("TAG.CAT_INTENT_CAPITAL").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CAT_INTENT_CAPITAL";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CAT_INTENT_CAPITAL";
