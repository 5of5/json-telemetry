//! Unique operator "BIN.TAG.PERSON_REGULATOR" ("TAG.PERSON_REGULATOR").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_REGULATOR";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_REGULATOR";
