//! Unique operator "BIN.TAG.CAT_FAMILY_SWIMLANE" ("TAG.CAT_FAMILY_SWIMLANE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CAT_FAMILY_SWIMLANE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CAT_FAMILY_SWIMLANE";
