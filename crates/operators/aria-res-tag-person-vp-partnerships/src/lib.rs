//! Unique operator "BIN.TAG.PERSON_VP_PARTNERSHIPS" ("TAG.PERSON_VP_PARTNERSHIPS").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_VP_PARTNERSHIPS";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_VP_PARTNERSHIPS";
