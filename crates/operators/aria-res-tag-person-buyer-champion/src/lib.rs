//! Unique operator "BIN.TAG.PERSON_BUYER_CHAMPION" ("TAG.PERSON_BUYER_CHAMPION").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_BUYER_CHAMPION";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_BUYER_CHAMPION";
