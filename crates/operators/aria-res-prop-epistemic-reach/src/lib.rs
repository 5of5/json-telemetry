//! Unique operator "BIN.PROP.EPISTEMIC_REACH" ("PROP.EPISTEMIC_REACH").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.PROP.EPISTEMIC_REACH";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "PROP.EPISTEMIC_REACH";
