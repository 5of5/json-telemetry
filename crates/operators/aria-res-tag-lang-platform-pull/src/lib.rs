//! Unique operator "BIN.TAG.LANG_PLATFORM_PULL" ("TAG.LANG_PLATFORM_PULL").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_PLATFORM_PULL";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_PLATFORM_PULL";
