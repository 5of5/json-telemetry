//! Unique operator "BIN.TAG.LANG_STACK_MIDDLEWARE" ("TAG.LANG_STACK_MIDDLEWARE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_STACK_MIDDLEWARE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_STACK_MIDDLEWARE";
