//! Unique operator "BIN.REF.PRODUCT_CAPABILITY" ("REF.PRODUCT_CAPABILITY").
//!
//! Map mixer: slices already-tagged JSON telemetry into this sealed
//! market-map type. Source bytes are never rewritten.

/// Catalog identity.
pub const BINARY_ID: &str = "BIN.REF.PRODUCT_CAPABILITY";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "REF.PRODUCT_CAPABILITY";
