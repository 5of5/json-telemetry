//! Unique operator "BIN.TAG.CAT_FAMILY_TIMELINE" ("TAG.CAT_FAMILY_TIMELINE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CAT_FAMILY_TIMELINE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CAT_FAMILY_TIMELINE";
