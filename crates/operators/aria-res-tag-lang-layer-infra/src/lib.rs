//! Unique operator "BIN.TAG.LANG_LAYER_INFRA" ("TAG.LANG_LAYER_INFRA").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_LAYER_INFRA";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_LAYER_INFRA";
