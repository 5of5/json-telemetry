//! Unique operator "BIN.TAG.LANG_OPERATOR_NODE" ("TAG.LANG_OPERATOR_NODE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_OPERATOR_NODE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_OPERATOR_NODE";
