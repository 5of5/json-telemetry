//! Unique operator "BIN.TAG.LANG_MOMENTUM_DOWN" ("TAG.LANG_MOMENTUM_DOWN").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_MOMENTUM_DOWN";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_MOMENTUM_DOWN";
