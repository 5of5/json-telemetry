//! Unique operator "BIN.TAG.VIRALITY_METRICS" ("TAG.VIRALITY_METRICS").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.VIRALITY_METRICS";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.VIRALITY_METRICS";
