//! Unique operator "BIN.TAG.LANG_ATTENTION_HEAT" ("TAG.LANG_ATTENTION_HEAT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_ATTENTION_HEAT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_ATTENTION_HEAT";
