//! Unique operator "BIN.REF.FOUNDER_OPERATOR_LINEAGE" ("REF.FOUNDER_OPERATOR_LINEAGE").
//!
//! Map mixer: slices already-tagged JSON telemetry into this sealed
//! market-map type. Source bytes are never rewritten.

/// Catalog identity.
pub const BINARY_ID: &str = "BIN.REF.FOUNDER_OPERATOR_LINEAGE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "REF.FOUNDER_OPERATOR_LINEAGE";
