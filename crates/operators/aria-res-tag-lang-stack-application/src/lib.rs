//! Unique operator "BIN.TAG.LANG_STACK_APPLICATION" ("TAG.LANG_STACK_APPLICATION").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_STACK_APPLICATION";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_STACK_APPLICATION";
