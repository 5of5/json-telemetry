//! Unique operator "BIN.TAG.CAT_FAMILY_NETWORK" ("TAG.CAT_FAMILY_NETWORK").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CAT_FAMILY_NETWORK";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CAT_FAMILY_NETWORK";
