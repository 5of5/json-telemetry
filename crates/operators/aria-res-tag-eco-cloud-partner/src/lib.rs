//! Unique operator "BIN.TAG.ECO_CLOUD_PARTNER" ("TAG.ECO_CLOUD_PARTNER").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.ECO_CLOUD_PARTNER";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.ECO_CLOUD_PARTNER";
