//! Unique operator "BIN.TAG.PERSON_BUYER_USER" ("TAG.PERSON_BUYER_USER").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_BUYER_USER";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_BUYER_USER";
