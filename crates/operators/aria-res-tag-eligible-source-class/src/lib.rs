//! Unique operator "BIN.TAG.ELIGIBLE_SOURCE_CLASS" ("TAG.ELIGIBLE_SOURCE_CLASS").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.ELIGIBLE_SOURCE_CLASS";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.ELIGIBLE_SOURCE_CLASS";
