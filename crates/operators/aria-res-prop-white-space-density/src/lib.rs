//! Unique operator "BIN.PROP.WHITE_SPACE_DENSITY" ("PROP.WHITE_SPACE_DENSITY").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.PROP.WHITE_SPACE_DENSITY";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "PROP.WHITE_SPACE_DENSITY";
