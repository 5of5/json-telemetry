//! Unique operator "BIN.TAG.LANG_INTEGRATION" ("TAG.LANG_INTEGRATION").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_INTEGRATION";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_INTEGRATION";
