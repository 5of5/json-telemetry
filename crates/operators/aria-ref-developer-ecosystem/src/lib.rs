//! Unique operator "BIN.REF.DEVELOPER_ECOSYSTEM" ("REF.DEVELOPER_ECOSYSTEM").
//!
//! Map mixer: slices already-tagged JSON telemetry into this sealed
//! market-map type. Source bytes are never rewritten.

/// Catalog identity.
pub const BINARY_ID: &str = "BIN.REF.DEVELOPER_ECOSYSTEM";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "REF.DEVELOPER_ECOSYSTEM";
