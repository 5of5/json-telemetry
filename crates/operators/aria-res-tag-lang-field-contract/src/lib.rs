//! Unique operator "BIN.TAG.LANG_FIELD_CONTRACT" ("TAG.LANG_FIELD_CONTRACT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_FIELD_CONTRACT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_FIELD_CONTRACT";
