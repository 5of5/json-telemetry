//! Unique operator "BIN.TAG.CO_ACQUISITION_TARGET" ("TAG.CO_ACQUISITION_TARGET").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CO_ACQUISITION_TARGET";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CO_ACQUISITION_TARGET";
