//! Unique operator "BIN.TAG.LANG_EXECUTIVE_BRIEF" ("TAG.LANG_EXECUTIVE_BRIEF").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_EXECUTIVE_BRIEF";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_EXECUTIVE_BRIEF";
