//! Unique operator "BIN.TAG.LANG_CAPITAL_PATH" ("TAG.LANG_CAPITAL_PATH").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_CAPITAL_PATH";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_CAPITAL_PATH";
