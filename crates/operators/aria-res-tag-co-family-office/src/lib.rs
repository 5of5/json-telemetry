//! Unique operator "BIN.TAG.CO_FAMILY_OFFICE" ("TAG.CO_FAMILY_OFFICE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CO_FAMILY_OFFICE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CO_FAMILY_OFFICE";
