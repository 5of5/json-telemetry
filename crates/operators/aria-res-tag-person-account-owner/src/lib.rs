//! Unique operator "BIN.TAG.PERSON_ACCOUNT_OWNER" ("TAG.PERSON_ACCOUNT_OWNER").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_ACCOUNT_OWNER";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_ACCOUNT_OWNER";
