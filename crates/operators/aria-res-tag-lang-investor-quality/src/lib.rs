//! Unique operator "BIN.TAG.LANG_INVESTOR_QUALITY" ("TAG.LANG_INVESTOR_QUALITY").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_INVESTOR_QUALITY";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_INVESTOR_QUALITY";
