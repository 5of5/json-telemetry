//! Unique operator "BIN.TAG.LANG_WARM_PATH_ACCOUNT" ("TAG.LANG_WARM_PATH_ACCOUNT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_WARM_PATH_ACCOUNT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_WARM_PATH_ACCOUNT";
