//! Unique operator "BIN.TAG.PERSON_COMPLIANCE" ("TAG.PERSON_COMPLIANCE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_COMPLIANCE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_COMPLIANCE";
