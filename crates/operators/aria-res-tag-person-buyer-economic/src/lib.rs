//! Unique operator "BIN.TAG.PERSON_BUYER_ECONOMIC" ("TAG.PERSON_BUYER_ECONOMIC").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_BUYER_ECONOMIC";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_BUYER_ECONOMIC";
