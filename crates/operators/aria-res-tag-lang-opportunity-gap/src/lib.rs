//! Unique operator "BIN.TAG.LANG_OPPORTUNITY_GAP" ("TAG.LANG_OPPORTUNITY_GAP").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_OPPORTUNITY_GAP";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_OPPORTUNITY_GAP";
