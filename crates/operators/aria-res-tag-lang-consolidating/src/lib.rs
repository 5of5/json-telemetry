//! Unique operator "BIN.TAG.LANG_CONSOLIDATING" ("TAG.LANG_CONSOLIDATING").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_CONSOLIDATING";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_CONSOLIDATING";
