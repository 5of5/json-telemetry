//! Unique operator "BIN.TAG.LANG_CREATOR_NODE" ("TAG.LANG_CREATOR_NODE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_CREATOR_NODE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_CREATOR_NODE";
