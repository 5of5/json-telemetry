//! Unique operator "BIN.TAG.LANG_NEED_INTENSITY" ("TAG.LANG_NEED_INTENSITY").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_NEED_INTENSITY";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_NEED_INTENSITY";
