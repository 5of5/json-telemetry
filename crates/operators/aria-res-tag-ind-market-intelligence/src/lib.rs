//! Unique operator "BIN.TAG.IND_MARKET_INTELLIGENCE" ("TAG.IND_MARKET_INTELLIGENCE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.IND_MARKET_INTELLIGENCE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.IND_MARKET_INTELLIGENCE";
