//! Unique operator "BIN.TAG.LANG_MISSING_PROOF_LANE" ("TAG.LANG_MISSING_PROOF_LANE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_MISSING_PROOF_LANE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_MISSING_PROOF_LANE";
