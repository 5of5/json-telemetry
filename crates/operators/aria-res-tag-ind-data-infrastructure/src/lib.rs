//! Unique operator "BIN.TAG.IND_DATA_INFRASTRUCTURE" ("TAG.IND_DATA_INFRASTRUCTURE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.IND_DATA_INFRASTRUCTURE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.IND_DATA_INFRASTRUCTURE";
