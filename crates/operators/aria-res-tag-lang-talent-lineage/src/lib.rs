//! Unique operator "BIN.TAG.LANG_TALENT_LINEAGE" ("TAG.LANG_TALENT_LINEAGE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_TALENT_LINEAGE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_TALENT_LINEAGE";
