//! Unique operator "BIN.TAG.CAT_FINTECH_INFRA" ("TAG.CAT_FINTECH_INFRA").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CAT_FINTECH_INFRA";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CAT_FINTECH_INFRA";
