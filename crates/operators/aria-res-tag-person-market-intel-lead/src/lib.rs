//! Unique operator "BIN.TAG.PERSON_MARKET_INTEL_LEAD" ("TAG.PERSON_MARKET_INTEL_LEAD").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_MARKET_INTEL_LEAD";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_MARKET_INTEL_LEAD";
