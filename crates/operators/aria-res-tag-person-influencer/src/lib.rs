//! Unique operator "BIN.TAG.PERSON_INFLUENCER" ("TAG.PERSON_INFLUENCER").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_INFLUENCER";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_INFLUENCER";
