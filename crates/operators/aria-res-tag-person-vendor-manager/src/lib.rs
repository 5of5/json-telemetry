//! Unique operator "BIN.TAG.PERSON_VENDOR_MANAGER" ("TAG.PERSON_VENDOR_MANAGER").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_VENDOR_MANAGER";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_VENDOR_MANAGER";
