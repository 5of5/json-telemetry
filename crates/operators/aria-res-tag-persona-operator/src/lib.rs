//! Unique operator "BIN.TAG.PERSONA_OPERATOR" ("TAG.PERSONA_OPERATOR").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSONA_OPERATOR";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSONA_OPERATOR";
