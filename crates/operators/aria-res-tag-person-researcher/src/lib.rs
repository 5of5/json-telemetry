//! Unique operator "BIN.TAG.PERSON_RESEARCHER" ("TAG.PERSON_RESEARCHER").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_RESEARCHER";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_RESEARCHER";
