//! Unique operator "BIN.TAG.PERSON_HEAD_GROWTH" ("TAG.PERSON_HEAD_GROWTH").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_HEAD_GROWTH";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_HEAD_GROWTH";
