//! Unique operator "BIN.TAG.LANG_PARTNER_PATH_ENTRY" ("TAG.LANG_PARTNER_PATH_ENTRY").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_PARTNER_PATH_ENTRY";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_PARTNER_PATH_ENTRY";
