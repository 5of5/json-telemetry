//! Unique operator "BIN.TAG.CAT_INTENT_COMPARE" ("TAG.CAT_INTENT_COMPARE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CAT_INTENT_COMPARE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CAT_INTENT_COMPARE";
