//! Unique operator "BIN.TAG.LANG_RECENCY_HEAT" ("TAG.LANG_RECENCY_HEAT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_RECENCY_HEAT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_RECENCY_HEAT";
