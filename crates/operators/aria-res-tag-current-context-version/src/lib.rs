//! Unique operator "BIN.TAG.CURRENT_CONTEXT_VERSION" ("TAG.CURRENT_CONTEXT_VERSION").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CURRENT_CONTEXT_VERSION";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CURRENT_CONTEXT_VERSION";
