//! Unique operator "BIN.TAG.IND_CAPITAL_MARKETS" ("TAG.IND_CAPITAL_MARKETS").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.IND_CAPITAL_MARKETS";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.IND_CAPITAL_MARKETS";
