//! Unique operator "BIN.TAG.LANG_CATEGORY_FORMATION" ("TAG.LANG_CATEGORY_FORMATION").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_CATEGORY_FORMATION";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_CATEGORY_FORMATION";
