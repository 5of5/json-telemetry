//! Unique operator "BIN.TAG.LANG_CATEGORY_CREATOR_LANE" ("TAG.LANG_CATEGORY_CREATOR_LANE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_CATEGORY_CREATOR_LANE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_CATEGORY_CREATOR_LANE";
