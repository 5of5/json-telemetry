//! Unique operator "BIN.TAG.PERSON_HEAD_ENGINEERING" ("TAG.PERSON_HEAD_ENGINEERING").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_HEAD_ENGINEERING";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_HEAD_ENGINEERING";
