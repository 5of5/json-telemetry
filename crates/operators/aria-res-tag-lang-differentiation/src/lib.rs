//! Unique operator "BIN.TAG.LANG_DIFFERENTIATION" ("TAG.LANG_DIFFERENTIATION").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_DIFFERENTIATION";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_DIFFERENTIATION";
