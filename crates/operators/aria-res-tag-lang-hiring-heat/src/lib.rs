//! Unique operator "BIN.TAG.LANG_HIRING_HEAT" ("TAG.LANG_HIRING_HEAT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_HIRING_HEAT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_HIRING_HEAT";
