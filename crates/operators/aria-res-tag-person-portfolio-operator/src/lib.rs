//! Unique operator "BIN.TAG.PERSON_PORTFOLIO_OPERATOR" ("TAG.PERSON_PORTFOLIO_OPERATOR").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_PORTFOLIO_OPERATOR";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_PORTFOLIO_OPERATOR";
