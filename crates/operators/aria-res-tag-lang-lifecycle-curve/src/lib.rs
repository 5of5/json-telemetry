//! Unique operator "BIN.TAG.LANG_LIFECYCLE_CURVE" ("TAG.LANG_LIFECYCLE_CURVE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_LIFECYCLE_CURVE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_LIFECYCLE_CURVE";
