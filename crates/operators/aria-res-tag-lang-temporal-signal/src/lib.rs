//! Unique operator "BIN.TAG.LANG_TEMPORAL_SIGNAL" ("TAG.LANG_TEMPORAL_SIGNAL").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_TEMPORAL_SIGNAL";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_TEMPORAL_SIGNAL";
