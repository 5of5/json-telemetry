//! Unique operator "BIN.TAG.LANG_STRATEGIC_TARGET" ("TAG.LANG_STRATEGIC_TARGET").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_STRATEGIC_TARGET";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_STRATEGIC_TARGET";
