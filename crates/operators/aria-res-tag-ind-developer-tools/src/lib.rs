//! Unique operator "BIN.TAG.IND_DEVELOPER_TOOLS" ("TAG.IND_DEVELOPER_TOOLS").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.IND_DEVELOPER_TOOLS";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.IND_DEVELOPER_TOOLS";
