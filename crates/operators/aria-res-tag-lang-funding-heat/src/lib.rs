//! Unique operator "BIN.TAG.LANG_FUNDING_HEAT" ("TAG.LANG_FUNDING_HEAT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_FUNDING_HEAT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_FUNDING_HEAT";
