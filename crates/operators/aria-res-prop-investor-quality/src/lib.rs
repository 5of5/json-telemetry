//! Unique operator "BIN.PROP.INVESTOR_QUALITY" ("PROP.INVESTOR_QUALITY").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.PROP.INVESTOR_QUALITY";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "PROP.INVESTOR_QUALITY";
