//! Unique operator "BIN.TAG.LANG_WHITE_SPACE_DENSITY" ("TAG.LANG_WHITE_SPACE_DENSITY").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_WHITE_SPACE_DENSITY";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_WHITE_SPACE_DENSITY";
