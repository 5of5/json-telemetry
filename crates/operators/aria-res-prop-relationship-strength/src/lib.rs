//! Unique operator "BIN.PROP.RELATIONSHIP_STRENGTH" ("PROP.RELATIONSHIP_STRENGTH").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.PROP.RELATIONSHIP_STRENGTH";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "PROP.RELATIONSHIP_STRENGTH";
