//! Unique operator "BIN.TAG.PERSON_ANALYST_FIRM" ("TAG.PERSON_ANALYST_FIRM").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_ANALYST_FIRM";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_ANALYST_FIRM";
