//! Unique operator "BIN.TAG.LANG_COMPLETENESS_METRIC" ("TAG.LANG_COMPLETENESS_METRIC").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_COMPLETENESS_METRIC";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_COMPLETENESS_METRIC";
