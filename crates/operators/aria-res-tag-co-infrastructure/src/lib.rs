//! Unique operator "BIN.TAG.CO_INFRASTRUCTURE" ("TAG.CO_INFRASTRUCTURE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CO_INFRASTRUCTURE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CO_INFRASTRUCTURE";
