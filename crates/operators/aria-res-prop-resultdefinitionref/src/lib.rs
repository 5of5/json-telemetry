//! Unique operator "BIN.PROP.RESULTDEFINITIONREF" ("PROP.RESULTDEFINITIONREF").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.PROP.RESULTDEFINITIONREF";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "PROP.RESULTDEFINITIONREF";
