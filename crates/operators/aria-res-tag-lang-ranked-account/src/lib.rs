//! Unique operator "BIN.TAG.LANG_RANKED_ACCOUNT" ("TAG.LANG_RANKED_ACCOUNT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_RANKED_ACCOUNT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_RANKED_ACCOUNT";
