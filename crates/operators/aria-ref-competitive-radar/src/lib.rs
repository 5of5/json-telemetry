//! Unique operator "BIN.REF.COMPETITIVE_RADAR" ("REF.COMPETITIVE_RADAR").
//!
//! Map mixer: slices already-tagged JSON telemetry into this sealed
//! market-map type. Source bytes are never rewritten.

/// Catalog identity.
pub const BINARY_ID: &str = "BIN.REF.COMPETITIVE_RADAR";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "REF.COMPETITIVE_RADAR";
