//! Unique operator "BIN.PROP.DIFFERENTIATION" ("PROP.DIFFERENTIATION").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.PROP.DIFFERENTIATION";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "PROP.DIFFERENTIATION";
