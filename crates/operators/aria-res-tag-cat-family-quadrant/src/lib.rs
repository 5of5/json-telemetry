//! Unique operator "BIN.TAG.CAT_FAMILY_QUADRANT" ("TAG.CAT_FAMILY_QUADRANT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CAT_FAMILY_QUADRANT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CAT_FAMILY_QUADRANT";
