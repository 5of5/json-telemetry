//! Unique operator "BIN.TAG.LANG_CATEGORY_DISTANCE" ("TAG.LANG_CATEGORY_DISTANCE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_CATEGORY_DISTANCE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_CATEGORY_DISTANCE";
