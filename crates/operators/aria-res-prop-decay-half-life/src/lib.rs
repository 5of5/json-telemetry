//! Unique operator "BIN.PROP.DECAY_HALF_LIFE" ("PROP.DECAY_HALF_LIFE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.PROP.DECAY_HALF_LIFE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "PROP.DECAY_HALF_LIFE";
