//! Unique operator "BIN.TAG.LANG_CATEGORY_NEIGHBORHOOD" ("TAG.LANG_CATEGORY_NEIGHBORHOOD").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_CATEGORY_NEIGHBORHOOD";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_CATEGORY_NEIGHBORHOOD";
