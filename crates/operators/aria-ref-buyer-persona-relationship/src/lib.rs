//! Unique operator "BIN.REF.BUYER_PERSONA_RELATIONSHIP" ("REF.BUYER_PERSONA_RELATIONSHIP").
//!
//! Map mixer: slices already-tagged JSON telemetry into this sealed
//! market-map type. Source bytes are never rewritten.

/// Catalog identity.
pub const BINARY_ID: &str = "BIN.REF.BUYER_PERSONA_RELATIONSHIP";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "REF.BUYER_PERSONA_RELATIONSHIP";
