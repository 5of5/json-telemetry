//! Unique operator "BIN.REF.INVESTOR_SYNDICATE" ("REF.INVESTOR_SYNDICATE").
//!
//! Map mixer: slices already-tagged JSON telemetry into this sealed
//! market-map type. Source bytes are never rewritten.

/// Catalog identity.
pub const BINARY_ID: &str = "BIN.REF.INVESTOR_SYNDICATE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "REF.INVESTOR_SYNDICATE";
