//! Unique operator "BIN.TAG.IND_PRIVATE_EQUITY" ("TAG.IND_PRIVATE_EQUITY").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.IND_PRIVATE_EQUITY";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.IND_PRIVATE_EQUITY";
