//! Unique operator "BIN.TAG.PERSON_HEAD_PRODUCT" ("TAG.PERSON_HEAD_PRODUCT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_HEAD_PRODUCT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_HEAD_PRODUCT";
