//! Unique operator "BIN.TAG.LANG_COMPACT_NARRATIVE" ("TAG.LANG_COMPACT_NARRATIVE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_COMPACT_NARRATIVE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_COMPACT_NARRATIVE";
