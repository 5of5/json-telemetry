//! Unique operator "BIN.TAG.PERSON_EXECUTIVE" ("TAG.PERSON_EXECUTIVE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_EXECUTIVE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_EXECUTIVE";
