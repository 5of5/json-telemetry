//! Unique operator "BIN.TAG.PERSON_HEAD_DEVREL" ("TAG.PERSON_HEAD_DEVREL").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_HEAD_DEVREL";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_HEAD_DEVREL";
