//! Unique operator "BIN.TAG.IND_CONFIDENTIAL_COMPUTE" ("TAG.IND_CONFIDENTIAL_COMPUTE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.IND_CONFIDENTIAL_COMPUTE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.IND_CONFIDENTIAL_COMPUTE";
