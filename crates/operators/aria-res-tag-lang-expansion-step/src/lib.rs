//! Unique operator "BIN.TAG.LANG_EXPANSION_STEP" ("TAG.LANG_EXPANSION_STEP").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_EXPANSION_STEP";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_EXPANSION_STEP";
