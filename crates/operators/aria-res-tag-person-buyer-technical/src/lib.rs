//! Unique operator "BIN.TAG.PERSON_BUYER_TECHNICAL" ("TAG.PERSON_BUYER_TECHNICAL").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_BUYER_TECHNICAL";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_BUYER_TECHNICAL";
