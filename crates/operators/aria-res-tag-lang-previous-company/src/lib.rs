//! Unique operator "BIN.TAG.LANG_PREVIOUS_COMPANY" ("TAG.LANG_PREVIOUS_COMPANY").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_PREVIOUS_COMPANY";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_PREVIOUS_COMPANY";
