//! Unique operator "BIN.TAG.LANG_MOMENTUM_FLAT" ("TAG.LANG_MOMENTUM_FLAT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_MOMENTUM_FLAT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_MOMENTUM_FLAT";
