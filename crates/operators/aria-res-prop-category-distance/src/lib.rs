//! Unique operator "BIN.PROP.CATEGORY_DISTANCE" ("PROP.CATEGORY_DISTANCE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.PROP.CATEGORY_DISTANCE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "PROP.CATEGORY_DISTANCE";
