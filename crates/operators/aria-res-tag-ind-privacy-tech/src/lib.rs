//! Unique operator "BIN.TAG.IND_PRIVACY_TECH" ("TAG.IND_PRIVACY_TECH").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.IND_PRIVACY_TECH";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.IND_PRIVACY_TECH";
