//! Unique operator "BIN.TAG.IND_ENTERPRISE_SAAS" ("TAG.IND_ENTERPRISE_SAAS").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.IND_ENTERPRISE_SAAS";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.IND_ENTERPRISE_SAAS";
