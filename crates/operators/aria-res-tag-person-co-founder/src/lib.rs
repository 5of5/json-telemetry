//! Unique operator "BIN.TAG.PERSON_CO_FOUNDER" ("TAG.PERSON_CO_FOUNDER").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_CO_FOUNDER";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_CO_FOUNDER";
