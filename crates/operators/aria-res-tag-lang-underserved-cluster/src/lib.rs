//! Unique operator "BIN.TAG.LANG_UNDERSERVED_CLUSTER" ("TAG.LANG_UNDERSERVED_CLUSTER").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_UNDERSERVED_CLUSTER";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_UNDERSERVED_CLUSTER";
