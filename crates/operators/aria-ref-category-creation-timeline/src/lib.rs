//! Unique operator "BIN.REF.CATEGORY_CREATION_TIMELINE" ("REF.CATEGORY_CREATION_TIMELINE").
//!
//! Map mixer: slices already-tagged JSON telemetry into this sealed
//! market-map type. Source bytes are never rewritten.

/// Catalog identity.
pub const BINARY_ID: &str = "BIN.REF.CATEGORY_CREATION_TIMELINE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "REF.CATEGORY_CREATION_TIMELINE";
