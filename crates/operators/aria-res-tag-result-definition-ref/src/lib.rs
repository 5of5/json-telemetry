//! Unique operator "BIN.TAG.RESULT_DEFINITION_REF" ("TAG.RESULT_DEFINITION_REF").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.RESULT_DEFINITION_REF";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.RESULT_DEFINITION_REF";
