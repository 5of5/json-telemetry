//! Unique operator "BIN.TAG.DATA_POINT_BUDGET" ("TAG.DATA_POINT_BUDGET").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.DATA_POINT_BUDGET";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.DATA_POINT_BUDGET";
