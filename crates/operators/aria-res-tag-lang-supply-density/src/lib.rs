//! Unique operator "BIN.TAG.LANG_SUPPLY_DENSITY" ("TAG.LANG_SUPPLY_DENSITY").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_SUPPLY_DENSITY";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_SUPPLY_DENSITY";
