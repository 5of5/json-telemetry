//! Unique operator "BIN.PROP.COMPETITIVE_PRESSURE" ("PROP.COMPETITIVE_PRESSURE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.PROP.COMPETITIVE_PRESSURE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "PROP.COMPETITIVE_PRESSURE";
