//! Unique operator "BIN.TAG.LANG_PROBLEM_POINT" ("TAG.LANG_PROBLEM_POINT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_PROBLEM_POINT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_PROBLEM_POINT";
