//! Unique operator "BIN.TAG.LANG_REGIONAL_RISK" ("TAG.LANG_REGIONAL_RISK").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_REGIONAL_RISK";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_REGIONAL_RISK";
