//! Unique operator "BIN.TAG.PERSON_VENTURE_PARTNER" ("TAG.PERSON_VENTURE_PARTNER").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_VENTURE_PARTNER";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_VENTURE_PARTNER";
