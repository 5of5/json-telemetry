//! Unique operator "BIN.TAG.IND_THIRD_PARTY_RISK" ("TAG.IND_THIRD_PARTY_RISK").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.IND_THIRD_PARTY_RISK";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.IND_THIRD_PARTY_RISK";
