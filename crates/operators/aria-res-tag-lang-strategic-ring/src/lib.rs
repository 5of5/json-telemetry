//! Unique operator "BIN.TAG.LANG_STRATEGIC_RING" ("TAG.LANG_STRATEGIC_RING").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_STRATEGIC_RING";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_STRATEGIC_RING";
