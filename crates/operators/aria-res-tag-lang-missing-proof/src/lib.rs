//! Unique operator "BIN.TAG.LANG_MISSING_PROOF" ("TAG.LANG_MISSING_PROOF").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_MISSING_PROOF";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_MISSING_PROOF";
