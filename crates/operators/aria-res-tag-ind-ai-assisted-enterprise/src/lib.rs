//! Unique operator "BIN.TAG.IND_AI_ASSISTED_ENTERPRISE" ("TAG.IND_AI_ASSISTED_ENTERPRISE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.IND_AI_ASSISTED_ENTERPRISE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.IND_AI_ASSISTED_ENTERPRISE";
