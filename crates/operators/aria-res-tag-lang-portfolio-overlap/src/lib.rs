//! Unique operator "BIN.TAG.LANG_PORTFOLIO_OVERLAP" ("TAG.LANG_PORTFOLIO_OVERLAP").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_PORTFOLIO_OVERLAP";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_PORTFOLIO_OVERLAP";
