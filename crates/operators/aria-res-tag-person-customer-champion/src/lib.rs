//! Unique operator "BIN.TAG.PERSON_CUSTOMER_CHAMPION" ("TAG.PERSON_CUSTOMER_CHAMPION").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_CUSTOMER_CHAMPION";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_CUSTOMER_CHAMPION";
