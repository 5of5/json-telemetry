//! Unique operator "BIN.TAG.PERSON_PRINCIPAL" ("TAG.PERSON_PRINCIPAL").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_PRINCIPAL";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_PRINCIPAL";
