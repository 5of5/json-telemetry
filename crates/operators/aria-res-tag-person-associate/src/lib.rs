//! Unique operator "BIN.TAG.PERSON_ASSOCIATE" ("TAG.PERSON_ASSOCIATE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_ASSOCIATE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_ASSOCIATE";
