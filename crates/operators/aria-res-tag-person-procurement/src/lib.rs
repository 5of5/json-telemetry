//! Unique operator "BIN.TAG.PERSON_PROCUREMENT" ("TAG.PERSON_PROCUREMENT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_PROCUREMENT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_PROCUREMENT";
