//! Unique operator "BIN.TAG.LANG_PROOF_POINT" ("TAG.LANG_PROOF_POINT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_PROOF_POINT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_PROOF_POINT";
