//! Unique operator "BIN.TAG.LANG_EVIDENCE_STRENGTH" ("TAG.LANG_EVIDENCE_STRENGTH").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_EVIDENCE_STRENGTH";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_EVIDENCE_STRENGTH";
