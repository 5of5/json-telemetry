//! Unique operator "BIN.TAG.PERSONA_GOVERNANCE" ("TAG.PERSONA_GOVERNANCE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSONA_GOVERNANCE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSONA_GOVERNANCE";
