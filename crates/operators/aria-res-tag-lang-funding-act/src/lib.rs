//! Unique operator "BIN.TAG.LANG_FUNDING_ACT" ("TAG.LANG_FUNDING_ACT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_FUNDING_ACT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_FUNDING_ACT";
