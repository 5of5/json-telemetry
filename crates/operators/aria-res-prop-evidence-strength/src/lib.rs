//! Unique operator "BIN.PROP.EVIDENCE_STRENGTH" ("PROP.EVIDENCE_STRENGTH").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.PROP.EVIDENCE_STRENGTH";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "PROP.EVIDENCE_STRENGTH";
