//! Unique operator "BIN.TAG.LANG_THREAT_MEDIUM" ("TAG.LANG_THREAT_MEDIUM").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_THREAT_MEDIUM";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_THREAT_MEDIUM";
