//! Unique operator "BIN.TAG.LANG_ENTRY_WEDGE" ("TAG.LANG_ENTRY_WEDGE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_ENTRY_WEDGE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_ENTRY_WEDGE";
