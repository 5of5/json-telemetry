//! Unique operator "BIN.TAG.PERSON_HEAD_SALES" ("TAG.PERSON_HEAD_SALES").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_HEAD_SALES";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_HEAD_SALES";
