//! Unique operator "BIN.TAG.LANG_PROVEN_CUSTOMER_CONTEXT" ("TAG.LANG_PROVEN_CUSTOMER_CONTEXT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_PROVEN_CUSTOMER_CONTEXT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_PROVEN_CUSTOMER_CONTEXT";
