//! Unique operator "BIN.PROP.LIFECYCLE_POSITION" ("PROP.LIFECYCLE_POSITION").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.PROP.LIFECYCLE_POSITION";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "PROP.LIFECYCLE_POSITION";
