//! Unique operator "BIN.TAG.IND_GRAPH_CONTEXT_SYSTEMS" ("TAG.IND_GRAPH_CONTEXT_SYSTEMS").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.IND_GRAPH_CONTEXT_SYSTEMS";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.IND_GRAPH_CONTEXT_SYSTEMS";
