//! Unique operator "BIN.TAG.LANG_DISTINCTIVENESS" ("TAG.LANG_DISTINCTIVENESS").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_DISTINCTIVENESS";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_DISTINCTIVENESS";
