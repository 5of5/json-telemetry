//! Unique operator "BIN.TAG.IND_VENTURE_CAPITAL" ("TAG.IND_VENTURE_CAPITAL").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.IND_VENTURE_CAPITAL";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.IND_VENTURE_CAPITAL";
