//! Unique operator "BIN.PROP.SIGNAL_STRENGTH" ("PROP.SIGNAL_STRENGTH").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.PROP.SIGNAL_STRENGTH";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "PROP.SIGNAL_STRENGTH";
