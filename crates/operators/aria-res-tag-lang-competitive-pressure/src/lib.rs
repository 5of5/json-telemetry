//! Unique operator "BIN.TAG.LANG_COMPETITIVE_PRESSURE" ("TAG.LANG_COMPETITIVE_PRESSURE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_COMPETITIVE_PRESSURE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_COMPETITIVE_PRESSURE";
