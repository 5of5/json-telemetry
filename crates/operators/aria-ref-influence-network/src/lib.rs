//! Unique operator "BIN.REF.INFLUENCE_NETWORK" ("REF.INFLUENCE_NETWORK").
//!
//! Map mixer: slices already-tagged JSON telemetry into this sealed
//! market-map type. Source bytes are never rewritten.

/// Catalog identity.
pub const BINARY_ID: &str = "BIN.REF.INFLUENCE_NETWORK";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "REF.INFLUENCE_NETWORK";
