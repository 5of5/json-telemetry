//! Unique operator "BIN.TAG.LANG_THREAT_CRITICAL" ("TAG.LANG_THREAT_CRITICAL").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_THREAT_CRITICAL";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_THREAT_CRITICAL";
