//! Unique operator "BIN.TAG.IND_PARTNER_ECOSYSTEM_INTEL" ("TAG.IND_PARTNER_ECOSYSTEM_INTEL").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.IND_PARTNER_ECOSYSTEM_INTEL";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.IND_PARTNER_ECOSYSTEM_INTEL";
