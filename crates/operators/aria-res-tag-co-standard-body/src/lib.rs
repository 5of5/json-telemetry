//! Unique operator "BIN.TAG.CO_STANDARD_BODY" ("TAG.CO_STANDARD_BODY").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CO_STANDARD_BODY";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CO_STANDARD_BODY";
