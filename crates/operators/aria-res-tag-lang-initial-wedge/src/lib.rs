//! Unique operator "BIN.TAG.LANG_INITIAL_WEDGE" ("TAG.LANG_INITIAL_WEDGE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_INITIAL_WEDGE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_INITIAL_WEDGE";
