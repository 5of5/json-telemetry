//! Unique operator "BIN.TAG.IND_RESEARCH_DECISION_INTEL" ("TAG.IND_RESEARCH_DECISION_INTEL").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.IND_RESEARCH_DECISION_INTEL";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.IND_RESEARCH_DECISION_INTEL";
