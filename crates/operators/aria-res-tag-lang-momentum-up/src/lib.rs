//! Unique operator "BIN.TAG.LANG_MOMENTUM_UP" ("TAG.LANG_MOMENTUM_UP").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_MOMENTUM_UP";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_MOMENTUM_UP";
