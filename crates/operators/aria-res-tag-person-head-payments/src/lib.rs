//! Unique operator "BIN.TAG.PERSON_HEAD_PAYMENTS" ("TAG.PERSON_HEAD_PAYMENTS").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_HEAD_PAYMENTS";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_HEAD_PAYMENTS";
