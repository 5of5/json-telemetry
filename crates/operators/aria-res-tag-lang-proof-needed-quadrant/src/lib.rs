//! Unique operator "BIN.TAG.LANG_PROOF_NEEDED_QUADRANT" ("TAG.LANG_PROOF_NEEDED_QUADRANT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_PROOF_NEEDED_QUADRANT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_PROOF_NEEDED_QUADRANT";
