//! Unique operator "BIN.TAG.LANG_CROWDED_AREA" ("TAG.LANG_CROWDED_AREA").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_CROWDED_AREA";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_CROWDED_AREA";
