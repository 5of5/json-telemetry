//! Unique operator "BIN.TAG.LANG_WARM_PATH_HOP" ("TAG.LANG_WARM_PATH_HOP").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_WARM_PATH_HOP";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_WARM_PATH_HOP";
