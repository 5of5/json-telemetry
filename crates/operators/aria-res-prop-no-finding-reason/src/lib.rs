//! Unique operator "BIN.PROP.NO_FINDING_REASON" ("PROP.NO_FINDING_REASON").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.PROP.NO_FINDING_REASON";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "PROP.NO_FINDING_REASON";
