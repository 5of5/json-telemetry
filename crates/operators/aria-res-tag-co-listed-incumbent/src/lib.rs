//! Unique operator "BIN.TAG.CO_LISTED_INCUMBENT" ("TAG.CO_LISTED_INCUMBENT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CO_LISTED_INCUMBENT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CO_LISTED_INCUMBENT";
