//! Unique operator "BIN.TAG.PERSON_SOLUTIONS_ENGINEER" ("TAG.PERSON_SOLUTIONS_ENGINEER").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_SOLUTIONS_ENGINEER";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_SOLUTIONS_ENGINEER";
