//! Unique operator "BIN.REL.CONTAINS_SEGMENT" ("REL.CONTAINS_SEGMENT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.REL.CONTAINS_SEGMENT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "REL.CONTAINS_SEGMENT";
