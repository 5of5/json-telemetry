//! Unique operator "BIN.TAG.LANG_LIST_PRICE_ABSENT" ("TAG.LANG_LIST_PRICE_ABSENT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_LIST_PRICE_ABSENT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_LIST_PRICE_ABSENT";
