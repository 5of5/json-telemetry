//! Unique operator "BIN.TAG.PERSON_INVESTMENT_PARTNER" ("TAG.PERSON_INVESTMENT_PARTNER").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.PERSON_INVESTMENT_PARTNER";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.PERSON_INVESTMENT_PARTNER";
