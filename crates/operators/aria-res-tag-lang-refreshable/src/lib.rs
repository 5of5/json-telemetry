//! Unique operator "BIN.TAG.LANG_REFRESHABLE" ("TAG.LANG_REFRESHABLE").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_REFRESHABLE";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_REFRESHABLE";
