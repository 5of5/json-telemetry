//! Unique operator "BIN.TAG.LANG_COMPARISON_MATRIX" ("TAG.LANG_COMPARISON_MATRIX").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_COMPARISON_MATRIX";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_COMPARISON_MATRIX";
