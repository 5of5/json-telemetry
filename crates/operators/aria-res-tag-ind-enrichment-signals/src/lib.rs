//! Unique operator "BIN.TAG.IND_ENRICHMENT_SIGNALS" ("TAG.IND_ENRICHMENT_SIGNALS").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.IND_ENRICHMENT_SIGNALS";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.IND_ENRICHMENT_SIGNALS";
