//! Unique operator "BIN.TAG.LANG_THREAT_HIGH" ("TAG.LANG_THREAT_HIGH").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_THREAT_HIGH";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_THREAT_HIGH";
