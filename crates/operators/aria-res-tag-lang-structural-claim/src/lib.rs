//! Unique operator "BIN.TAG.LANG_STRUCTURAL_CLAIM" ("TAG.LANG_STRUCTURAL_CLAIM").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_STRUCTURAL_CLAIM";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_STRUCTURAL_CLAIM";
