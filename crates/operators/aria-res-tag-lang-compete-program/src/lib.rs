//! Unique operator "BIN.TAG.LANG_COMPETE_PROGRAM" ("TAG.LANG_COMPETE_PROGRAM").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_COMPETE_PROGRAM";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_COMPETE_PROGRAM";
