//! Unique operator "BIN.PROP.VIRAL_COEFFICIENT" ("PROP.VIRAL_COEFFICIENT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.PROP.VIRAL_COEFFICIENT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "PROP.VIRAL_COEFFICIENT";
