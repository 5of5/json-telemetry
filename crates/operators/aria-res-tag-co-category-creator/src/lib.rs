//! Unique operator "BIN.TAG.CO_CATEGORY_CREATOR" ("TAG.CO_CATEGORY_CREATOR").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CO_CATEGORY_CREATOR";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CO_CATEGORY_CREATOR";
