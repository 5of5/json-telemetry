//! Unique operator "BIN.TAG.CAT_FAMILY_BRIEF" ("TAG.CAT_FAMILY_BRIEF").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CAT_FAMILY_BRIEF";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CAT_FAMILY_BRIEF";
