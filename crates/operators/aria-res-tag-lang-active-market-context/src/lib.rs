//! Unique operator "BIN.TAG.LANG_ACTIVE_MARKET_CONTEXT" ("TAG.LANG_ACTIVE_MARKET_CONTEXT").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_ACTIVE_MARKET_CONTEXT";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_ACTIVE_MARKET_CONTEXT";
