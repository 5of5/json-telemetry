//! Unique operator "BIN.TAG.CAT_MARKET_INTEL" ("TAG.CAT_MARKET_INTEL").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.CAT_MARKET_INTEL";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.CAT_MARKET_INTEL";
