//! Unique operator "BIN.TAG.LANG_ADJACENT_BUYER" ("TAG.LANG_ADJACENT_BUYER").
//!
...
/// Catalog identity.
pub const BINARY_ID: &str = "BIN.TAG.LANG_ADJACENT_BUYER";
/// Operator name on the closed envelope.
pub const OPERATOR: &str = "TAG.LANG_ADJACENT_BUYER";
